...
class KeyboardController : public Component{
    public:
        ...
        void update() override{
            ...
            vec proj_vel(1.0, 0.0);
            Animation fly(1, 1000, 6, 3);
            Projectile* proj;
            ...
            if (Game::event.type == SDL_KEYDOWN){
                ...
                case SDLK_k:
                    if (!projectile && entity->has_group(PlayerGroup)){   
                        ...
                        // time being.
                        projectile = true;
                        proj = new Projectile(entity->manager, "Projectile", "projectile1", fly, 1000, transform->get_position()+vec(100, 0), 20, proj_vel);
